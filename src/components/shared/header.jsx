   ...
   <div className='flex justify-between items-center lg:gap-[100px]  md:gap-[50px] gap-[20px] pl-5 md:pr-10 pr-5'>
      ...
      <div className='flex items-center lg:justify-between  justify-end w-full gap-5 mt-[5px]'>
        ...
        <div className='flex flex-col gap-4'>
            <button onClick={goToMainPage} className="bg-black text-white px-[22px] py-2 text-xs md:text-base  cursor-pointer rounded-lg">Visit Website</button>
            <button onClick={() => setOpenForm(true)} className="bg-black text-white px-3 py-2  text-xs md:text-base cursor-pointer rounded-lg">Contribute Now</button>
        </div>
      </div>
   </div>
  )
